...
- Key recording and the business effect in the **same transaction**. Outside it there's
  a window where the effect happens and the key doesn't stick — and the retry
  duplicates.
